...
export default function TupeloHoneyAlert({ setOpenTupeloHoneyModal }) {
  return (
    <>
      <div className="fixed inset-0 z-10 overflow-y-auto">
        ...
        <div
          ...
          onClick={() => setOpenTupeloHoneyModal(false)}
        ></div>
            ...
            <div className="mt-3 mb-4 sm:flex">
              <div className="mt-2 sm:ml-[4rem] sm:text-left">
                ...
                <div className="float-left">
                  <p>
                  + Memorize menu items for customized recommendations
                  </p>
                  <p>
                    + Successfully resolve all conflict to result in customer satisfaction
                  </p>
                  <p>
                  + Carry out back of house requirements in conjunction with front of house service
                  </p>
                  <p>
