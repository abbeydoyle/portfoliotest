...
export default function ORISEAlert({ setOpenORISEModal }) {
  return (
    <>
      <div className="fixed inset-0 z-10 overflow-y-auto">
        ...
        <div
          ...
          onClick={() => setOpenORISEModal(false)}
        ></div>
            ...
            <div className="mt-3 mb-4 sm:flex">
              <div className="mt-2 sm:ml-[4rem] sm:text-left">
                ...
                <div className="float-left">
                  ...
                  <p>
                    + Interface with software developers on custom products to best fit the lab's automation needs
                  </p>
                </div>
              </div>
            </div>
